...
import com.sanguo.www.dto.UploadFileVO;
...
public class UploadFileController {
     ...
     * 文件保存目录，物理路径
     */
    public final String rootPath = "C:/Users/user/ForestBlog/uploads/";
    ...
    public JsonResult uploadFile(@RequestParam("file") MultipartFile file) {
        ...
        log.info("xudonghui");
        log.info("debug dateDirs {}", JSONUtil.toJsonStr(dateDirs));
        //目标文件
        ...
        log.info("debug descFile {}", JSONUtil.toJsonStr(descFile));
        //3.存储文件
        //将内存中的数据写入磁盘
        try {
